import modalWindowHtml from './template/modal.window.html';


angular.module('ui.bootstrap._modal', ['ui.bootstrap.multiMap', 'ui.bootstrap.stackedMap', 'ui.bootstrap.position'])
/**
  ...
  function($modalStack, $q, $animateCss, $document) {
    return {
      ...
      templateUrl: function(tElement, tAttrs) {
        return tAttrs.templateUrl || modalWindowHtml;
      },
